...
{
    /// <inheritdoc />
    public partial class InstanceRoles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddColumn<DateTimeOffset>(
                name: "PermissionsReviewedAt",
                table: "SiteSettings",
                type: "timestamp with time zone",
                nullable: true);

            migrationBuilder.AddColumn<Guid>(
                name: "PermissionsReviewedById",
                table: "SiteSettings",
                type: "uuid",
                nullable: true);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.RoleId, x.Key });
                    table.ForeignKey(
