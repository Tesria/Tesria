...
export const TIPS: Tip[] = [
  ...
  },
  {
    ...
    body: 'Tab moves an item under the one above it, and Shift+Tab brings it back out.',
    priority: 7,
  ...
  },
  {
    ...
    body: 'It covers the title and text of every page you can see. Narrow it to one space when a word is everywhere.',
    clip: 'search',
    priority: 5,
